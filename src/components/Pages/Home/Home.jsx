...
const HomePage = () => {
 return ( 
  <div className=" container mh-5 " id="Home">
  <div  className="row d-inline-flex  justify-content-between p-3 ">
    ...
    <br/>
    <div>
     <button  className="btn btn-primary btn-lg w-100 " > <a href="#Contact" className="text-white text-decoration-none"> Get in Touch </a></button>
     <br/>
     <br/>
     <button  id="" className="btn btn-outline-light btn-lg  w-100 text-white ">
     <a href="https://github.com/Abdulzeez403"
      className="text-white text-decoration-none"> Explore my Github</a> </button>
    ...
    <div className="col-md-4  mt-5  ">
     ...
     className="rounded-2  " style={{ border:"5px solid white", width:"25rem"}}/>
    </div>
